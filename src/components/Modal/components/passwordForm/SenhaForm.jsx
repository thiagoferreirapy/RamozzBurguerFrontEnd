...
const SenhaForm = ({
  ...
  const handleSubmit = (e) => {
    ...
    if (senha.length < 8) {
      ...
      alert(
        "Senha inválida, a senha deve conter pelo menos 8 caracteres entre eles uma letra 'maiúscula', uma letra 'minúscula', um 'número' e um 'caractere especial'"
      );
      setIsSenhaValida(false);
      setMsgPasswordError(
        "Senha inválida, a senha deve conter pelo menos 8 caracteres entre eles uma letra maiúscula, uma letra minúscula, um número e um caractere especial"
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <LabelForm>
        ...
        <Text>
          Senha deve conter pelo menos 1 letra maiúscula, 1 letra minuscula, 1
