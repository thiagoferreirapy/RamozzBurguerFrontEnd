...
export default function PorcaoSelector({
  typecarne,
  quantidade,
  onSelectionChange,
  hasErrorPorcao,
  ...
  return (
    <ContainerItemSelector>
      <ContentTitleSelector id={id}>
        <ContentAlign>
          <TitleSelector>Escolha o tamanho da porção</TitleSelector>
          <AlertSelector hasErrorPorcao={hasErrorPorcao}>
            obrigatório
          </AlertSelector>
        </ContentAlign>
        <ContentAlign>
