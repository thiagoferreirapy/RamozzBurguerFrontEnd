    ...
    <FooterContainer>
      <ContentFooter>
        <ContentInformations>
          ...
          <AlertMsg>
            *Observação: A cozinha encerra 30 min antes do estabelecimento
            fechar.
          </AlertMsg>
        </ContentInformations>
        <ContentLinksInstitucional>
        ...
        <ContentContato>
          <ContentAling>
            ...
            <ContentIconsTextAlign>
              <ImgIcon src={loc} />
              <TextNormal>
                Rua Artur de Azevedo, 898 Pinheiros, São Paulo/SP
              </TextNormal>
            </ContentIconsTextAlign>
            <ContentIconsTextAlign>
              <ImgIcon src={phone} />
              <TextNormal>
                <Links>(11) 994162084</Links>
              </TextNormal>
            </ContentIconsTextAlign>
            <ContentIconsTextAlign>
              <ImgIcon src={whats} />
            ...
            <ContentRedesSociais>
              ...
              <RedesSociais>
                <Link
                  to={"https://www.instagram.com/thiagosferreira__/"}
                  target="blank"
                >
                ...
                <Link
                  to={
                    "https://www.tiktok.com/search?q=restaurante%20em%20sp&t=1706973243598"
                  }
                  target="blank"
                >
                  <ImgIconRedes src={tiktok} />
                </Link>
                <Link to={"https://br.pinterest.com/"} target="blank">
      ...
      <ContentDirectedFooter>
        <ContentIconsTextAlign>
          <TextNormal>
            Hamburgueria RAMOZZ BURGUERS 2023 - Todos os direitos reservados
          </TextNormal>
        </ContentIconsTextAlign>
        <ContentIconsTextAlign>
